<?php
/**
* WPPIZZA_LAYOUT Class
*
* @package     WPPIZZA
* @subpackage  Submenu Pages / Classes / Layout
...
class WPPIZZA_LAYOUT{
	...
	* @since 3.0
	*/
	private $class_key='layout';/*to help consistency throughout class in various places*/
	...
	*/
	...
	function __construct() {
		...
		/**add settings sections for this submenu page**/
    ...
    *******************/
	public function init_admin_lables(){
		/*titles/labels throughout class*/
		$this->submenu_page_header	=	apply_filters('wppizza_filter_admin_label_page_header_'.$this->class_key.'', __('Layout','wppizza-admin'));
		$this->submenu_page_title	=	apply_filters('wppizza_filter_admin_label_page_title_'.$this->class_key.'', __('Manage Layout Settings','wppizza-admin'));
		$this->submenu_caps_title	=	apply_filters('wppizza_filter_admin_label_caps_title_'.$this->class_key.'', __('Layout','wppizza-admin'));
		$this->submenu_link_label	=	apply_filters('wppizza_filter_admin_label_link_label_'.$this->class_key.'', __('&middot; Layout','wppizza-admin'));			
	}
	/******************
	*	@since 3.0
    *	[admin ajax include file]
	...
	*********************************************************/
	public function wppizza_register_submenu_page(){
		...
		/**add contextual help - currently disabled as unused**/
...
*
***************************************************************/
$WPPIZZA_LAYOUT = new WPPIZZA_LAYOUT();
?>