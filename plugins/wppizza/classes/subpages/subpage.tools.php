...
*
* @package     WPPIZZA
* @subpackage  Submenu Pages / Classes / Tools
...
class WPPIZZA_TOOLS{
	...
	* @since 3.0
	*/
	private $class_key='tools';/*to help consistency throughout class in various places*/
	/*
	* titles/lables
	* @var str
	* @since 3.0
    ...
    *******************/
	public function init_admin_lables(){
		/**
			titles/labels throughout class
		**/
		$this->submenu_page_header	=	apply_filters('wppizza_filter_admin_label_page_header_'.$this->class_key.'', __('Tools','wppizza-admin'));
		$this->submenu_page_title	=	apply_filters('wppizza_filter_admin_label_page_title_'.$this->class_key.'', __('Manage Tools','wppizza-admin'));
		$this->submenu_caps_title	=	apply_filters('wppizza_filter_admin_label_caps_title_'.$this->class_key.'', __('Tools','wppizza-admin'));
		$this->submenu_link_label	=	apply_filters('wppizza_filter_admin_label_link_label_'.$this->class_key.'', __('&middot; Tools','wppizza-admin'));
	}
	...
	*********************************************************/
	public function wppizza_admin_manage_sections(){
		...
		*/
		...
		echo'<input type="hidden" name="'.WPPIZZA_SLUG.'_'.$this->class_key.'_'.$tabs['current'].'" value="1" />';
	...
	*********************************************************/
	function wppizza_admin_tabs() {
		/**
			available tabs => label, slug, sections in page for tab, enable save button - filterable
		**/
		$tabs = array();
		$tabs['tab']['miscellaneous']=array('lbl'=>__('Miscellaneous','wppizza-admin'), 'slug'=>'miscellaneous', 'sections'=>array(), 'save_options' => true);
		$tabs['tab']['privacy']=array('lbl'=>__('Privacy (GDPR)','wppizza-admin'), 'slug'=> 'privacy', 'sections'=>array(), 'save_options' => true);
		$tabs['tab']['maintenance']=array('lbl'=>__('Maintenance','wppizza-admin'), 'slug'=>'maintenance', 'sections'=>array(), 'save_options' => true);
		$tabs['tab']['sysinfo']=array('lbl'=>__('System Info','wppizza-admin'), 'slug'=>'sysinfo', 'sections'=>array(), 'save_options' => false);
...
*
***************************************************************/
$WPPIZZA_TOOLS = new WPPIZZA_TOOLS();
?>