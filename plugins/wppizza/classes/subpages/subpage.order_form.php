<?php
/**
* WPPIZZA_SUBPAGES_ORDER_FORM
*
* @package     WPPIZZA
* @subpackage  Submenu Pages / Classes / Order Form
...
*
************************************************************************************************************************/
class WPPIZZA_SUBPAGES_ORDER_FORM{
	...
	* @since 3.0
	*/
	private $class_key='order_form';/*to help consistency throughout class in various places*/
	/*
	...
	******************************************************************************************************************/
	function __construct() {
		...
		/** registering submenu page -> priority 20 **/
    ...
    *******************/
	public function init_admin_lables(){
		/*titles/labels throughout class*/
		$this->submenu_page_header	=	apply_filters('wppizza_filter_admin_label_page_header_'.$this->class_key.'', __('Order Form','wppizza-admin'));
		$this->submenu_page_title	=	apply_filters('wppizza_filter_admin_label_page_title_'.$this->class_key.'', __('Manage Order Form','wppizza-admin'));
		$this->submenu_caps_title	=	apply_filters('wppizza_filter_admin_label_caps_title_'.$this->class_key.'', __('Order Form','wppizza-admin'));
		$this->submenu_link_label	=	apply_filters('wppizza_filter_admin_label_link_label_'.$this->class_key.'', __('&middot; Order Form','wppizza-admin'));		
	}	
	/******************
	*	@since 3.0
    *	[admin ajax include file]
...
*
***************************************************************/
$WPPIZZA_SUBPAGES_ORDER_FORM = new WPPIZZA_SUBPAGES_ORDER_FORM();
?>