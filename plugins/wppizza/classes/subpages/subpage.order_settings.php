<?php
/**
* WPPIZZA_ORDER_SETTINGS Class
*
* @package     WPPIZZA
* @subpackage  Submenu Pages / Classes / Order Settings
...
*
*
*	WPPIZZA_ORDER_SETTINGS
*
*
************************************************************************************************************************/
class WPPIZZA_SUBPAGES_ORDER_SETTINGS{
	/*
	* class ident
	* @var str
	* @since 3.0
	*/
	private $class_key='order_settings';
	/*
	* titles/lables
	* @var str
	* @since 3.0
	*/
	...
	private $submenu_priority = 10;
	/******************************************************************************************************************
	*
	*	[CONSTRUCTOR]
	*
	*	Setup wppizza_order_settings subpage
	*	@since 3.0
	*
	******************************************************************************************************************/
	function __construct() {
		...
		/** registering submenu page -> priority 10 **/
    ...
    *******************/
	public function init_admin_lables(){
		/*titles/labels throughout class*/
		$this->submenu_page_header	=	apply_filters('wppizza_filter_admin_label_page_header_'.$this->class_key.'', __('Order Settings','wppizza-admin'));
		$this->submenu_page_title	=	apply_filters('wppizza_filter_admin_label_page_title_'.$this->class_key.'', __('Manage Order Settings','wppizza-admin'));
		$this->submenu_caps_title	=	apply_filters('wppizza_filter_admin_label_caps_title_'.$this->class_key.'', __('Order Settings','wppizza-admin'));
		$this->submenu_link_label	=	apply_filters('wppizza_filter_admin_label_link_label_'.$this->class_key.'', __('&middot; Order Settings','wppizza-admin'));		
	}	
	/******************
	*	@since 3.0
    *	[admin ajax include file]
...
*
***************************************************************/
$WPPIZZA_SUBPAGES_ORDER_SETTINGS = new WPPIZZA_SUBPAGES_ORDER_SETTINGS();
?>