<?php
/**
* WPPIZZA_MEAL_SIZES Class
*
* @package     WPPIZZA
* @subpackage  Submenu Pages / Classes / Meal Sizes
...
*
************************************************************************************************************************/
class WPPIZZA_MEAL_SIZES{
	/*
	* class ident
	* @var str
	* @since 3.0
	*/
	private $class_key='meal_sizes';/*to help consistency throughout class in various places*/

	/*
	* titles/lables/subpage priority (order of appearance)
	* @var str
	* @since 3.0
	*/
	...
	******************************************************************************************************************/
	function __construct() {
		...
		/** registering submenu page -> priority 50 **/
    ...
    *******************/
	public function init_admin_lables(){
		/*titles/labels throughout class*/
		$this->submenu_page_header	=	apply_filters('wppizza_filter_admin_label_page_header_'.$this->class_key.'', __('Meal Sizes','wppizza-admin'));
		$this->submenu_page_title	=	apply_filters('wppizza_filter_admin_label_page_title_'.$this->class_key.'', __('Manage Meal Sizes','wppizza-admin'));
		$this->submenu_caps_title	=	apply_filters('wppizza_filter_admin_label_caps_title_'.$this->class_key.'', __('Meal Sizes','wppizza-admin'));
		$this->submenu_link_label	=	apply_filters('wppizza_filter_admin_label_link_label_'.$this->class_key.'', __('&middot; Meal Sizes','wppizza-admin'));		
	}		
	/******************
	*	@since 3.0
    *	[admin ajax include file]
...
*
***************************************************************/
$WPPIZZA_MEAL_SIZES = new WPPIZZA_MEAL_SIZES();
?>