<?php
/**
* WPPIZZA_ADDITIVES Class
*
* @package     WPPIZZA
* @subpackage  Submenu Pages / Classes / Additives
...
*
************************************************************************************************************************/
class WPPIZZA_ADDITIVES{
	/*
	* class ident
	* @var str
	* @since 3.0
	*/
	private $class_key='additives';/*to help consistency throughout class in various places*/
	/*
	* saved wppizza option array key
	* @var str
	* @since 3.0
	*/
	//private $option_key='additives';
	/*
	* titles/lables/priorities
	* @var str
	* @since 3.0
	*/
	...
	******************************************************************************************************************/
	...
	function __construct() {
		...
		/** registering submenu page -> priority 60 **/
    ...
    *******************/
	public function init_admin_lables(){
		/*titles/labels throughout class*/
		$this->submenu_page_header	=	apply_filters('wppizza_filter_admin_label_page_header_'.$this->class_key.'', __('Additives','wppizza-admin'));
		$this->submenu_page_title	=	apply_filters('wppizza_filter_admin_label_page_title_'.$this->class_key.'', __('Manage Additives','wppizza-admin'));
		$this->submenu_caps_title	=	apply_filters('wppizza_filter_admin_label_caps_title_'.$this->class_key.'', __('Additives','wppizza-admin'));
		$this->submenu_link_label	=	apply_filters('wppizza_filter_admin_label_link_label_'.$this->class_key.'', __('&middot; Additives','wppizza-admin'));			
	}
...
*
***************************************************************/
$WPPIZZA_ADDITIVES = new WPPIZZA_ADDITIVES();
?>